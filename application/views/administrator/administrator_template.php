                    ...
                    <ul id="sidebarnav">
                        ...
                        <li>
                            ...
                            <div class="user-profile d-flex no-block dropdown m-t-20">
                                <div class="user-pic"><img src="<?=base_url().'media/'?>assets/images/users/2.jpg" alt="users"
                                        class="rounded-circle" width="40" /></div>
                                <div class="user-content hide-menu m-l-10">
                                    <a href="#" class="" id="Userdd" role="button"
                                        data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <h5 class="m-b-0 user-name font-medium">University Guidance Counsellor<i
                                                class="fa fa-angle-down"></i></h5>
                                        <span class="op-5 user-email">Administrator</span>
                                    </a>
                                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="Userdd">
                                        <a class="dropdown-item" href="<?=site_url().'administrator/admin_lists';?>"><i
                                                class="ti-user m-r-5 m-l-5"></i> Admin List</a>
                                    </div>
                                </div>
                            </div>
                            <!-- End User Profile-->
