                  ...
                  <tbody>
                    ...
                    foreach ($tblwellnessquestion->result() as $row) : ?>
                      <tr>
                        <td><?= $row->Question; ?></td>
                        <td>
                          <a href="<?= site_url() . 'administrator/wellness_question_update/' . $WellnessCheckID . '/' . $row->QuestionID; ?>" class="btn btn-outline-primary btn-sm" title="Edit" style="width: 100px;">Edit</a>
                          <a href="<?= site_url() . 'administrator/wellness_question_delete/' . $WellnessCheckID . '/' . $row->QuestionID; ?>" class="btn btn-outline-danger btn-sm" title="Delete" style="width: 100px;">Delete</a>
                        </td>
                      </tr>
                    <?php endforeach; ?>
                  </tbody>
