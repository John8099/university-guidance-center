...
$StudentName=$this->session->flashdata('StudentName');
$YearSection=$this->session->flashdata('YearSection');
$CollegeID=$this->session->flashdata('CollegeID');
$Address=$this->session->flashdata('Address');
$PhoneNumber=$this->session->flashdata('PhoneNumber');
$OtherContact=$this->session->flashdata('OtherContact');
$Category=$this->session->flashdata('Category');
$Platform=$this->session->flashdata('Platform');
$PreferredTime=$this->session->flashdata('PreferredTime');
$SelectedDate=$this->session->flashdata('SelectedDate');
...
<div class="row">
    ...
    <div class="col-lg-12 col-xlg-12 col-md-12">
        <div class="card">
            <div class="card-body">
                <form method="post" action="<?=site_url().'superadmin/appointment_save/'.$AppointmentID?>" class="form-horizontal form-material mx-2">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input name='txtEmail' type="text" placeholder="Enter student email here" class="form-control form-control-line" value="<?=$StudentName;?>" required />
                        </div>
                    </div>
                    <div class="form-group">
