    ...
    <tr>
        ...
        <td>
            <?php if($row->Status=='Disable') : ?>
                <a href="<?=site_url().'superadmin/wellness_check_status/'.$row->WellnessCheckID.'/Enable';?>" class="btn btn-outline-warning btn-sm" title="Set Enable" style="width: 100px;">Set Enable</a>
            <?php else: ?>
                <a href="<?=site_url().'superadmin/wellness_check_status/'.$row->WellnessCheckID.'/Disable';?>" class="btn btn-outline-warning btn-sm" title="Set Disable" style="width: 100px;">Set Disable</a>
            <?php endif; ?>
            <?php if ($row->Status=='Disable'): ?>
            ...
            <a href="<?=site_url().'superadmin/wellness_checks_delete/'.$row->WellnessCheckID;?>" class="btn btn-outline-danger btn-sm" title="Delete" style="width: 100px;">Delete</a>
            <?php else: ?>
