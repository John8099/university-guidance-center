    ...
    <?=$this->session->flashdata('Failed');?>
                                ...
                                <form class="form-horizontal form-material mx-2" action="<?=site_url().'superadmin/superadmin_login'?>" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" placeholder="Enter Admin ID" value="superadmin" 
                                                class="form-control form-control-line" required="required" name="txtUsername" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Password</label>
                                        <div class="col-md-12">
                                            <input type="password" placeholder="Enter Password" value="1234"
                                                class="form-control form-control-line" required="required" name="txtPassword" />
                                        </div>
                                    </div>
