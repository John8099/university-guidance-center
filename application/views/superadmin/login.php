...
<head>
  ...
  <title>WVSU Guidance Appointment and Monioring System | <?= $heading; ?></title>
  <!-- Favicon icon -->
      ...
      <div class="col-lg-4 offset-lg-4">
        <div class="card" style="background: none; color: #fff;">
          <div class="card-body">
            ...
            <form class="form-horizontal form-material mx-2" action="<?= site_url() . 'superadmin/superadmin_login' ?>" method="post">
                ...
                <div class="col-md-12">
                  <div class="custom-select">
                    <select class="form-control form-control-line" name="txtUserType" required="required" id="txtUserType">
                      ...
                      <option value="Superadmin" selected>University Guidance Counsellor</option>
                      <option value="Administrator">College Guidance Facilitator</option>
                    </select>
                  </div>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-md-12">
                  <input type="text" placeholder="Enter Admin ID" value="superadmin" class="form-control form-control-line" required="required" name="txtUsername" />
                </div>
              </div>
              <div class="form-group">
