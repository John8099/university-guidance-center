                ...
                <nav class="sidebar-nav">
                        ...
                        <li>
                            ...
                            <div class="user-profile dropdown m-t-20">
                                <div class="user-pic"><img src="<?=base_url('uploads/').$this->session->userdata('StudentImageLoc');?>" alt="users"
...
href="<?=site_url().'student/set_schedule_appointment'?>" aria-expanded="false"><i class="mdi mdi-calendar-multiple"></i><span
class="hide-menu">Schedule Appointment</span></a></li>

<li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
href="<?=site_url().'student/wellness_checks'?>" aria-expanded="false"><i class="mdi mdi-emoticon"></i><span
class="hide-menu">Wellness Check</span></a></li>

<li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
href="<?=site_url().'student/notification'?>" aria-expanded="false"><i class="mdi mdi-bell-ring"></i><span
class="hide-menu">Notification</span></a></li>

<li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
href="<?=site_url().'student/history'?>" aria-expanded="false"><i class="mdi mdi-history"></i><span class="hide-menu">History</span></a></li>
                    </ul>
