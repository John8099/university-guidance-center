...
<div class="alert alert-danger d-flex align-items-center d-none" role="alert" id="alertdanger">
  ...
  <div>
    Student referral failed, please try again.
                ...
                <form method="post" action="<?=site_url().'administrator/save_appointment_refer/'.$AppointmentID?>" class="form-horizontal form-material mx-2">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12 mt-4">
                            <a href="<?=site_url().'administrator/login'?>" class="btn btn-success text-white w-100" style="width: 180px;">Login</a>
                        </div>
                    </div>
