...
<div class="alert alert-danger d-flex align-items-center d-none" role="alert" id="alertdanger">
  ...
  <div>
    <?=$this->session->flashdata('Failed');?>
                                ...
                                <form class="form-horizontal form-material mx-2" action="<?=site_url().'student/student_login'?>" method="post">
                                    <?=$this->routines->InsertCSRF()?>
                                    <div class="form-group">
                                        <label for="example-email" class="col-md-12">Student ID</label>
                                        <div class="col-md-12">
                                            <input type="text" placeholder="Enter Student ID"
                                                class="form-control form-control-line" required="required" name="txtUsername" value="04-1314-01944" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="password" placeholder="Enter Password"
                                                class="form-control form-control-line" required="required" name="txtPassword" value="1234" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12 text-center">Don't have an account? <a href="<?=site_url().'student/student_register'?>" style="text-decoration: underline; color: #fff;">Register here</a></label>
                                    </div>
                                    <div class="form-group">
