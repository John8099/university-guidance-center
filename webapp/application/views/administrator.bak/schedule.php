...
<div class="alert alert-primary d-flex align-items-center d-none" role="alert" id="alertprimary">
  ...
  <div>
    Appointment schedule was successfully saved.
  </div>
</div>
...
<div class="alert alert-warning d-flex align-items-center d-none" role="alert" id="alertwarning">
  ...
  <div>
    Appointment schedule saving failed, please try again.
  </div>
</div>
<div class="alert alert-danger d-flex align-items-center d-none" role="alert" id="alertdanger">
  ...
  <div>
    Appointment schedule saving failed, please try again.
                ...
                <form method="post" action="<?=site_url().'administrator/schedule_save/'.$AppointmentSchedID?>" class="form-horizontal form-material mx-2">
                    <?=$this->routines->InsertCSRF()?>
                    <div class="form-group">
                        <label class="col-md-12">Appointment Date</label>
                        <div class="col-md-12">
                            <input name='txtAppointmentDate' type="date" placeholder="Enter appointment date here" class="form-control form-control-line" value="<?=$AppointmentDate;?>" required />
                        </div>
                    </div>
                    <div class="form-group">
